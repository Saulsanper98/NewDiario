  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto w-full overflow-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="loading-card p-4 flex items-center gap-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="loading-card p-4 lg:col-span-2 space-y-3">
      ...
      <div className="loading-card p-4 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="space-y-3 p-3.5 loading-card">
